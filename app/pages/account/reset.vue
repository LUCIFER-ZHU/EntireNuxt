        ...
        <form @submit.prevent="handleResetPassword" class="reset-form">
          ...
          <div class="form-group">
            <div class="input-wrapper">
              ...
              <UInput id="newPassword" v-model="form.newPassword" :type="showPassword ? 'text' : 'password'"
                placeholder="New Password" :disabled="loading" class="form-input" :ui="{ base: 'custom-input' }" />
...
const handleSendResetCode = async () => {
  ...
  try {
    const response: any = await sendResetCode(form.value.email, turnstileToken.value)
